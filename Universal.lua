...
local Window = Parvus.Utilities.UI:Window({
    ...
    local AimAssistTab = Window:Tab({Name = "Combat"}) do
        ...
        local AimbotSection = AimAssistTab:Section({Name = "Aimbot",Side = "Left"}) do
            ...
            AimbotSection:Dropdown({Name = "Priority",Flag = "Aimbot/BodyParts",List = {
        ...
        local SilentAimSection = AimAssistTab:Section({Name = "Silent Aim",Side = "Right"}) do
            ...
            SilentAimSection:Dropdown({Name = "Priority",Flag = "SilentAim/BodyParts",List = {
                {Name = "Head",Mode = "Toggle",Value = true},
                {Name = "HumanoidRootPart",Mode = "Toggle"}
            }})
        end
        ...
        local TriggerSection = AimAssistTab:Section({Name = "Trigger",Side = "Right"}) do
            ...
            TriggerSection:Dropdown({Name = "Priority",Flag = "Trigger/BodyParts",List = {
                {Name = "Head",Mode = "Toggle",Value = true},
                {Name = "HumanoidRootPart",Mode = "Toggle"}
            }})
    ...
    local SettingsTab = Window:Tab({Name = "Settings"}) do
        ...
        local CreditsSection = SettingsTab:Section({Name = "Credits",Side = "Right"}) do
            CreditsSection:Label({Text = "Tập lệnh này được thực hiện bởi Salemmax#103"})
